...
public class Tambah extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // Welcome Label
        Label welcomeLabel = new Label("TAMBAH DATA");
        ...
        gridPane.add(asalLabel, 0, 0);
        gridPane.add(asalField, 1, 0);
        gridPane.add(tujuanLabel, 0, 1);
        gridPane.add(tujuanField, 1, 1);
        gridPane.add(jamLabel, 0, 2);
        gridPane.add(jamField, 1, 2);
        gridPane.add(jumlahTiketLabel, 0, 3);
        gridPane.add(jumlahTiketField, 1, 3);
        gridPane.add(hargaTiketLabel, 0, 4);
        gridPane.add(hargaTiketField, 1, 4);
